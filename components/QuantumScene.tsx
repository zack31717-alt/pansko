...
// Aliases for JSX intrinsic elements to fix type errors in environments where 
// @react-three/fiber global types are not properly loaded into the JSX namespace.
...
const MacroscopicWave = () => {
  ...
  return (
    <Torus ref={ref} args={[3, 0.1, 16, 100]} rotation={[Math.PI / 2, 0, 0]}>
      {/* Use aliased component to avoid intrinsic element type error */}
  ...
  return (
    <div className="absolute inset-0 z-0 opacity-60 pointer-events-none">
      <Canvas camera={{ position: [0, 0, 6], fov: 45 }}>
        {/* Use aliased components to avoid intrinsic element type errors */}
